...
sc_RJoy.reset(new frc::JoystickButton(systemsController.get(), 10));
sc_RJoy->WhenPressed(new IntakeDown());
sc_LJoy.reset(new frc::JoystickButton(systemsController.get(), 9));
sc_LJoy->WhenPressed(new IntakeUp());
