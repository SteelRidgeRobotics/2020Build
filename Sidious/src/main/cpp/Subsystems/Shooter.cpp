...
void Shooter::InitDefaultCommand() {
    ...
    leftFalcon->Config_kF(0, kF, kTimeout);
    leftFalcon->Config_kP(0, kP, kTimeout);
    leftFalcon->Config_kI(0, kI, kTimeout);
    leftFalcon->Config_kD(0, kD, kTimeout);
...
if(velocity > 0.0)
{
    ...
    double v_data = leftFalcon->GetSelectedSensorVelocity();
