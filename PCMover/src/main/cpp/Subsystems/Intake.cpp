...
intakeMotor.reset(new WPI_TalonSRX(2));
...
void Intake::IntakeSloenoidOut()
{
    intakeSolenoid->Set(frc::DoubleSolenoid::kForward);
}

void Intake::IntakeSolenidIn()
{
    intakeSolenoid->Set(frc::DoubleSolenoid::kReverse);
}

void Intake::IntakeMotorForward()
{
    intakeMotor->Set(ControlMode::PercentOutput, 0.3);
}

void Intake::IntakeMotorBackward()
{
    intakeMotor->Set(ControlMode::PercentOutput, -0.3);
}

void Intake::IntakeMotorStop()
{
